//
//  EZR_EQRUnitSelect2ViewController.m
//  EZ-Resistor
//
...
#import "EZR_EQRUnitSelect2ViewController.h"

@interface EZR_EQRUnitSelect2ViewController ()

@property (nonatomic, strong) NSArray *units;

@end

@implementation EZR_EQRUnitSelect2ViewController
...
{
    static NSString *CellIdentifier = @"Unit2Cell";
